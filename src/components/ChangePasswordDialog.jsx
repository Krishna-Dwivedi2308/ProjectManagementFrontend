...
const ChangePasswordDialog = ({ open, onOpenChange }) => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Change Password <div className=""></div></DialogTitle>
                    <DialogDescription>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    <div>
                        ...
                        />
                        {state?.validationError?.oldPassword && <p className="text-red-500">{state.validationError?.oldPassword}</p>}
                    ...
                    <div>
                        ...
                        />
                        {state?.validationError?.newPassword && <p className="text-red-500">{state.validationError?.newPassword}</p>}
                    </div>
                    <div>
                        <Input
                            type="password"
                        ...
                        />
                        {state?.validationError?.confirmPassword && <p className="text-red-500">{state.validationError?.confirmPassword}</p>}
                    </div>
