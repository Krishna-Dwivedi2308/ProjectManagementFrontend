...
const ResendVerificationDialog = ({ open, onOpenChange }) => {
  ...
  const resendEmailTrigger = async () => {
    ...
    try {
      ...
      setSuccess(
        (res && (res.message || res.data?.message)) || 'Verification email sent. Check your inbox.'
      );
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Enter your email and password to receive a new verification link.Make sure to verify
            within 20 minutes.
          </DialogDescription>
        </DialogHeader>
